...
Llama~3.1~8B Instruct and Mistral~7B Instruct v0.3 locally from the Hugging Face Hub.
Both models were loaded with 4-bit NF4 quantization via bitsandbytes
\cite{dettmers2023qlora}, reducing memory consumption from approximately 16\,GB in half precision
